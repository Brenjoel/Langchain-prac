...
# Tools lang chain @tool decorator
...
def run_agent(question: str):
    ...
    llm_with_tools = llm.bind_tools(tools) # this function is only used when the model supports function calling 
...
if __name__ == "__main__":
    ...
    print ()
    question = "What is the price of laptop after applying the discount for a silver tier"
    resunt = run_agent(question)
